<tr valign="top">
    ...
    <td class="forminp">
        ...
        <div id="pleb_no_ruleset_notice" class="notice notice-info inline notice-alt pleb_notice" style="<?php if (!empty($classicRulesets) || $defaultRuleset): ?>display:none;<?php endif; ?>"><p><span class="dashicons dashicons-dismiss"></span> <?php _e("No ruleset yet.", 'pleb'); ?></p></div>
        ...
        <div class="metabox-holder" style="padding-top:0;">
            ...
            <div id="pleb_no_ruleset_default_notice" class="notice notice-info inline notice-alt pleb_notice" style="<?php if ($defaultRuleset): ?>display:none;<?php endif; ?>"><p><span class="dashicons dashicons-info"></span> <?php _e("No default ruleset yet.", 'pleb'); ?> <?php _e("The default ruleset allows you to apply a rate even if none of rulesets matches the shopping cart.", 'pleb'); ?></p></div>
